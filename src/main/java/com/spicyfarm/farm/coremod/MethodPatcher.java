...
public class MethodPatcher implements IClassTransformer{
    ...
    static {
        ...
        addPatch("net.minecraft.block.BlockFarmland.hasWater", "com.spicyfarm.farm.coremod.WorldPatches.hasWaterCondition", "com.spicyfarm.farm.coremod.WorldPatches.hasWater", DescriptorEncoder.encodeMethodHeader(boolean.class, "net.minecraft.world.World", BlockPos.class));
    }
